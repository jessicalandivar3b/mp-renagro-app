...
@Component({
  selector: 'app-b0201-02',
  templateUrl: './b0201-02.page.html',
  standalone: true,
...
export class B020102Page {
  ...
  public onButtonBack(): void {
    //this.navCtrl.navigateForward('/home/b0102');
    this.navCtrl.pop();
  }

  public onButtonNext(): void {
    this.navCtrl.navigateForward('home/b0203');
  }
}
