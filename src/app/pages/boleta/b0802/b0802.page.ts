...
export class B0802Page {
  private navCtrl = inject(NavController);
  public readonly catalogoService = inject(CatalogoService);

  public readonly miembroHogarService = inject(MiembroHogarService);
  public miembroHogar = this.miembroHogarService.miembroHogar;
  ...
  public onButtonNext(): void {
    this.navCtrl.navigateForward('/home/b0901');
  }

  public goToMiembrosPage(): void {
    this.navCtrl.navigateBack('/home/miembro-hogar');
  }
}
